...
namespace teacherKeyboards
{
    ...
    InlineKeyboardMarkup::Ptr create_list_users_kb(long chat_id=0, bool is_active=true);
    InlineKeyboardMarkup::Ptr create_user_info_kb(botUser&);
    InlineKeyboardMarkup::Ptr update_user_info_kb(std::string, long);
    InlineKeyboardMarkup::Ptr create_list_pupils_kb(long chat_id, bool is_active=true, bool update=false);
